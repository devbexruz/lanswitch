...
class AnimeCard(QFrame):
    ...
    def __init__(self, title, episodes):
        ...
        self.setFrameShape(QFrame.StyledPanel) # PyQt5 uchun to'g'rilandi
        self.setStyleSheet("""
            QFrame {
...
class LanswitchUI(QMainWindow):
    ...
    def init_player_page(self):
        ...
        video_label.setAlignment(Qt.AlignCenter) # PyQt5 uchun to'g'rilandi
...
if __name__ == "__main__":
    ...
    window = LanswitchUI()
    window.show()
    sys.exit(app.exec_()) # PyQt5 uchun to'g'rilandi